            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="/ru/home">Главная</a></li>
                        <li><a href="/Home/about">About</a></li>
                        <li><a href="/Home/Contacts">Contact</a></li>                       
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Язык<b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a href="/ru/<?=Core::$url; ?>">Русский</a></li>
                                <li><a href="/en/<?=Core::$url; ?>">English</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
								<li class="dropdown-header">Администрирование 2</li>
								<li><a href="/administrator" target="_blank">Админ-панель</a></li>
								<li class="divider"></li>
                    ...
                    <?php if  (isset(Auth_Library::$user)) { ?>

                    <ul class="nav navbar-nav navbar-right">

                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?=Auth_Library::$user['login']; ?><b class="caret"></b></a>
                            <ul class="dropdown-menu">
